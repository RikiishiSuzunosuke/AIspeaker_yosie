...
<<<<<<< HEAD
- 横浜システム工学院専門学校の略称である”YSE”を含んだ名前にしようと考えた
- 最終的な外見を和風(こけしや日本人形のような)にしようと思い、それに準ずる和風な名前が良いと考えた
- 平仮名・片仮名だと人名と紛らわしいため、アルファベット表記にした
=======
- YSEを含む名前にしたかった
- 和風な名前にしたかった
- 人名と紛らわしくなるためアルファベット表記にした
>>>>>>> 0f83f06a2acb478ecfa5f24c4632380479583130
...
2    | 開発者    | C#、MVC.NET、jQuery、SQL、DDD、DDD♯ユニットテスト、リファクタリング、TDD、継続的インテグレーション
